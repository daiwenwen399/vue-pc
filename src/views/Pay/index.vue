    ...
    <div class="pay-main">
        <div class="pay-container">
            ...
            <div class="checkout-steps">
                ...
                <div class="submit">
                    <el-button class="btn" type="text" @click="pay"
                        >立即支付</el-button
                    >
...
import { reqGetPayInfo } from "@api/pay";
...
export default {
    ...
    methods: {
        ...
        async pay() {
            // 发送获取订单支付信息的请求
            const result = await reqGetPayInfo(this.$route.query.orderId);
            // 生成二维码
            QRCode.toDataURL(result.codeUrl)
                ...
                .catch(() => {
                    this.$message.error("支付遇到了问题，请刷新试试");
                });
        },
    },
};
