    ...
    computed: {
        ...
        selectAddress() {
            ...
            return userAddressList
                ? userAddressList.find((user) => user.id === selectAddressId)
                : {};
        },
    },
    methods: {
        ...
        async submit() {
            const {
                tradeNo,
                detailArrayList,
                userAddressList: { consignee, phoneNum, userAddress },
            } = this.trade;
            ...
            const orderId = await reqSubmitOrder({
                ...
                paymentWay: "ONLINE",
                orderComment: this.remarksContent,
